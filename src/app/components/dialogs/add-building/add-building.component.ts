...
export class AddBuildingComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<AddBuildingComponent>,private ts:TokenStorageService,private cs:CenterServiceService,private authService: AuthService,private toastr: ToastrService,private BuildingService:BuildingService) { }
