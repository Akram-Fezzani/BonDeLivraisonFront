...
@Component({
  selector: 'app-demandevetobycenter-table',
  templateUrl: './demandevetobycenter-table.component.html',
  styleUrls: ['./demandevetobycenter-table.component.scss']
})
export class DemandevetobycenterTableComponent implements OnInit {
